...
/*   Updated: 2023/04/14 22:18:51 by pfalasch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_keyboard(int keyhook, t_game *game)
{
	...
	if (game->count_collectible == 0
		&& ((keyhook == 2 && game->map[game->player_y][game->player_x] == 'E')
		|| (keyhook == 1 && game->map[game->player_y][game->player_x] == 'E')
		|| (keyhook == 0 && game->map[game->player_y][game->player_x] == 'E')
		|| (keyhook == 13 && game->map[game->player_y][game->player_x]
		== 'E')))
	{
